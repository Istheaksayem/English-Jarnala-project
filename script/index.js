  ...
  wordContainer.innerHTML = `
    ...
    words.forEach(word => {
        ...
        <div class="flex justify-between items-center">
            <button class="btn bg-[#1A91ff10] hover:bg-[#1A91ff80]"><i class="fa-solid fa-circle-info"></i>
            </button>
            <button class="btn bg-[#1A91ff10] hover:bg-[#1A91ff80]"><i class="fa-solid fa-volume-high"></i>
            </button>
        </div>
     </div
        `
